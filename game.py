...
background = pygame.image.load('pandemic_bg.jpg')

#sound effects
mixer.music.load("all_gone_aftermath.mpeg")
...
player_img = pygame.image.load('earth.png')
playerX = 375
playerY = 490
playerX_change = 0
...
def game_over_message():
    over_text = end_font.render("CORONA WINS", True, (255, 0, 0))
